 ...
 * @n: int
 * @prev: points to prev element of (stack/queue)
 ...
 * Description: move val through the program
 */
...
/**
 * struct instruction_s - opcode &  func
 * @opcode: opcode
 * @f: func that handles de opcode
 *
 * Description: opcode & func (stack, queues, LIFO, FIFO)
 */
